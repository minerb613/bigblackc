...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
                ...
                dl.DownloadFile("https://github.com/minerb613/bigblackc/raw/main/miscs/bbc.dll", mainpath); //Replace "DLL URL" with the URL to directly download your DLL [Example: http://myurl.com/MYDLL.dll]
